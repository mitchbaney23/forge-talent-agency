        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-heading font-extrabold uppercase tracking-heading-tight leading-heading text-forge-charcoal mb-6">
              Our Featured <span className="text-forge-orange">Creator</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-3xl font-heading font-extrabold text-forge-charcoal">{featuredCreator.name}</h2>
                  <p className="text-xl text-forge-orange font-heading font-semibold">{featuredCreator.handle}</p>
                </div>
              </div>
              
              <p className="text-lg text-text-gray font-sans font-normal leading-body mb-8">
            ...
            {/* Featured Video */}
            <div>
              <h3 className="text-2xl font-heading font-semibold text-forge-charcoal mb-6">Most Recent Viral Hit</h3>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <SocialMediaEmbed
                  ...
                  className="mb-4"
                />
                <h4 className="text-lg font-heading font-semibold text-forge-charcoal mb-2">{featuredVideo.title}</h4>
                <p className="text-text-gray font-sans font-normal leading-body mb-4">{featuredVideo.description}</p>
              ...
              <div key={video.id} className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="bg-forge-orange text-white px-3 py-1 rounded-full text-sm font-montserrat font-semibold uppercase tracking-button">
                      View Count
                    </span>
                    <span className="text-forge-orange font-heading font-semibold">{video.views}</span>
                  </div>
                  ...
                  <h3 className="text-lg font-heading font-semibold text-forge-charcoal mb-2">{video.title}</h3>
                  <p className="text-text-gray font-sans font-normal leading-body text-sm mb-4">{video.description}</p>
                  
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    <span className="text-sm text-text-gray font-sans font-normal">Engagement Rate</span>
                    <span className="text-forge-orange font-heading font-semibold">{video.engagement}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-forge-orange">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-extrabold uppercase tracking-heading-tight leading-heading text-white mb-4">
            Ready to Work with Authentic <span className="text-forge-charcoal">Trade Professionals?</span>
          </h2>
